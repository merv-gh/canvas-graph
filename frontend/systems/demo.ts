...
import type { EdgeKind } from '../model/graph';
import type { Id, ItemRef } from '../types';
import { createDemoBuilder } from './demo-builder';
...
export function registerDemo(system: Registry) {
  system('demo', (ctx) => {
    ...
    ctx.contexts.commands.register(demoCommands());
