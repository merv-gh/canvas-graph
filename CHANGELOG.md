...
- Moved telemetry overhead enforcement into the isolated performance lane and
  made its coverage-run comparison resistant to runner scheduling noise.
...
[Unreleased]: https://github.com/merv-gh/canvas-graph/compare/v2.0.3...HEAD
[2.0.3]: https://github.com/merv-gh/canvas-graph/compare/v2.0.2...v2.0.3
